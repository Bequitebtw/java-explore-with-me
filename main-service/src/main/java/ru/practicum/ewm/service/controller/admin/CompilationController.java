...
public class CompilationController {
    ...
    public CompilationDto createCompilation(@RequestBody @Validated CompilationRequest compilationRequest, HttpServletRequest request) {
    ...
    public CompilationDto updateCompilationById(@PathVariable Integer compId, @RequestBody CompilationRequest compilationRequest, HttpServletRequest request) {
        statsClient.saveHit(requestUtils.createHit(request));
